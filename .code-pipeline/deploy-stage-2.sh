...
case "$AWS_ACCOUNT_ID" in
    ...
    "354918399435") ENVIRONMENT_NAME="staging" ;;  # Replace with your Staging AWS Account ID
    "111111111111") ENVIRONMENT_NAME="prod" ;;  # Replace with your Prod AWS Account ID
    *)
